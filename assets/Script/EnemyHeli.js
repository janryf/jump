...
cc.Class({
    ...
    checkCrash(player)
    {
        ...
        var right2 = heliNode.x + heliNode.width / 2 + this.node.x 
        var down2 = heliNode.y - heliNode.height / 2 + this.node.y
        var left2 = heliNode.x - heliNode.width / 2 + this.node.x
        ...
        if(this.calcPosRelation(top1, right1, down1, left1, top2, right2, down2, left2) == 0)
        {
            ...
            left1 = player.orgX
            var top3 = this.orgY
            var right3 = this.orgX + this.node.width
            var down3 = this.orgY - this.node.height - 5
            var left3 = this.orgX
